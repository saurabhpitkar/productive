...
export function AllTasks() {
  ...
  const docs = useMemo(() => {
    if (!allDocs) return []
    // Default: exclude archived; if status filter set, use it instead
    const base = status
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-lg font-semibold mb-3">All Docs</h1>
      <FilterToolbar
      ...
      />
      <TaskList docs={docs} emptyText="No docs match your filters." />
    </div>
  )
}
