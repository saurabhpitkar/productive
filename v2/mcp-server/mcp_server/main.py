...
Config (environment variables):
  PRODUCTIVE_API_URL  base URL of the backend (default: http://backend-v2:8000)
  PRODUCTIVE_PAT      personal access token (pa_…) for auth - generate in Settings → API Access
  MCP_TRANSPORT       "sse" (default) or "stdio"
  MCP_PORT            port for SSE transport (default: 3002)
"""
import argparse
import os
import sys
...
API_URL   = os.environ.get("PRODUCTIVE_API_URL", "http://backend-v2:8000")
