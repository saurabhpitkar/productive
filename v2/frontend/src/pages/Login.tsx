    ...
    <div className="min-h-dvh flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">v2 - Sign in to continue</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-gray-400 dark:text-gray-600">
          <a href="http://localhost:3000" className="underline hover:text-gray-600 dark:hover:text-gray-400">
            Use v1 (classic) instead
          </a>
        </p>
      </div>
    </div>
